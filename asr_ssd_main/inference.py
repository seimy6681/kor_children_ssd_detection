...
# CUSTOMIZE ------------------------------------------------------------
MODEL_TYPE = 'baseline' # 'baseline': Wav2Vec2, 'multitask': Multitask learning, 'fused': Multitask learning with Fused Attention
# MODEL_PATH = "/data/selinawisco/spring/0421_baseline_44" # 모델 경로
MODEL_PATH = "/data/selinawisco/journal_result/wav2vec2-word-level-asr-baseline_nas_data/five_fold_datasets/test_fold_0_train.csv_42" # 모델 경로
