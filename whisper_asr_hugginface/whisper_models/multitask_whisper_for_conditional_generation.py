...
class MultitaskWhisperForConditionalGeneration(WhisperForConditionalGeneration):
    ...
    def __init__(self, config: WhisperConfig):
        ...
        # self.generation_config = GenerationConfig.from_pretrained("openai/whisper-large-v3-turbo")
    ...
    def forward(
        ...
        if binary_labels is not None:
            ...
            # (7) calculate binary cross entropy loss
